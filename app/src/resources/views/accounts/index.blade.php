    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
                <li class="nav-item"><a href="{{ route('accounts.index')}}" class="nav-link disabled">アカウント</a>
                </li>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <button class="btn btn-danger btn-gradient border-2 delButton"
                                                ...
                                                data-account_name="{{$data['name']}}" data-account_id="{{$data['id']}}">
                                            削除
                                        </button>
                                    </div>
                                    <div class="col-md-5">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-default" data-bs-dismiss="modal" aria-label="Close">閉じる</button>
            </div>
        </div>
    </div>
</div>
...
<script type="module">
    ...
    // トーストを作成
    let toastLive_normally = createToast('パスワード更新完了', false);

    // トーストを表示する
    let toast_normally = new bootstrap.Toast(toastLive_normally);
    toast_normally.show();
