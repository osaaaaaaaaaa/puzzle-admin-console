    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
                ...
                <li class="nav-item"><a href="{{ url('players/index')}}" class="nav-link disabled">プレイヤー</a></li>
...
<div class="container p-5">
    <div class="row">
        <div class="col-md-12">
            <h1 class="pt-5 pb-3">■ プレイヤー一覧</h1>
            <form class="d-flex pb-3" role="search" method="post" action="{{ url('players/index')}}">
                @csrf
                <div class="row">
                    <div class="col-md-8">
